...
class Category(models.Model):
	title = models.CharField(max_length=250,help_text='Maximum 250 charaters.')
...
class Entry(models.Model):
	...
	slug = models.SlugField(unique_for_date = 'pub_date',help_text="Suggestd value automatically generated from title.Must be unique.")
...
class Link(models.Model):
	...
	via_name = models.CharField('Via',max_length=250,blank=True,
								help_text='The URL of thes site where you spotted the link.Optional.')
	via_url = models.CharField('Via URL',max_length=250,blank=True,
